...
export class ProductService {
      public listProducts = signal<IProduct[]>([
        ...
        { id: 5, name: 'Dell - XPS 13 13.4-inch FHD+ Laptop - Intel Core Ultra 7', price: 1299, stock: 2 },
        { id: 6, name: 'HP - Envy 16 16-inch Laptop - Intel Core i7 - 16GB - 1TB SSD', price: 1199, stock: 2 },
        { id: 7, name: 'Lenovo - Yoga 7i 14-inch 2-in-1 Laptop - Intel Core i5', price: 849, stock: 2 },
        { id: 8, name: 'ASUS - ROG Zephyrus G14 14-inch Gaming Laptop - Ryzen 9 - RTX 4060', price: 1599, stock: 2 },
        ...
        { id: 21, name: 'Bose - QuietComfort Ultra Wireless Noise Cancelling Headphones', price: 429, stock: 2 },
        { id: 22, name: 'Sony - WH-1000XM5 Wireless Noise Cancelling Headphones', price: 399, stock: 2 },
        { id: 23, name: 'Apple - AirPods Pro 2nd generation with MagSafe Case (USB-C)', price: 249, stock: 2 },
        ...
        { id: 33, name: 'Blink - Outdoor 4 Wireless Security Camera System (3-Camera)', price: 249, stock: 2 },
        ...
        { id: 39, name: 'Instant Pot - Duo Plus 9-in-1 Electric Pressure Cooker 6-Qt', price: 129, stock: 2 },
        { id: 40, name: 'KitchenAid - Artisan Series 5-Quart Tilt-Head Stand Mixer', price: 449, stock: 2 },
        { id: 41, name: 'Canon - EOS R50 Mirrorless Camera with RF-S 18-45mm Lens', price: 799, stock: 2 },
        { id: 42, name: 'Sony - Alpha a6700 Mirrorless Camera with 16-50mm Lens', price: 1499, stock: 2 },
        ...
        { id: 48, name: 'Razer - Huntsman V3 Pro TKL Wired Optical Gaming Keyboard', price: 219, stock: 2 },
        { id: 49, name: 'Anker - 737 Power Bank 24,000mAh 140W', price: 149, stock: 2 },
        { id: 50, name: 'Belkin - BoostCharge Pro 3-in-1 Wireless Charging Stand', price: 149, stock: 2 },
      ]);

      public cart = signal<(IProduct & {quantity: number})[]>([]);

      constructor() {
        console.log("ProductService has been instantiated");
      }
